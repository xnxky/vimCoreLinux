...
call s:check_defined('g:airline_fugitive_prefix', '')
call s:check_defined('g:airline_readonly_symbol', 'RO')
call s:check_defined('g:airline_linecolumn_prefix', ':')
...
function! s:init()
  if !s:airline_initialized
    ...
    call s:check_defined('g:airline_section_d', '')
